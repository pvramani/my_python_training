...
# Some Assumptions
# 1. If value/line starting with '123' then assume it is IP address line
# 2. If image name data starting with /pics/ then we can assume image name present
#   else we can assume image name is not present
...
print("#"*40, end="\n\n")
# ###############################
print("print each line data using for loop")
print("-"*20)
# -----------
