...
1) ENCAPSULATION: Keep data and related methods/variables together
2) ABSTRACTION: We just need to know how to use methods, no need to know how it is implemented
"""
